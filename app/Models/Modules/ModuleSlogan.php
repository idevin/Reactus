 ...
 * @method static Builder|ModuleSlogan whereContentOptions($value)
 */
class ModuleSlogan extends ModuleBase implements Module
{
    use \App\Traits\ModuleAnimationSettings;

    protected $table = 'module_slogan';
    public $timestamps = false;

    public $with = ['site'];

    protected $fillable = [
        'site_id', 'sort_order', 'name', 'content_options'
    ];
