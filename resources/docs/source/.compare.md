...
$client = new \GuzzleHttp\Client();
$response = $client->get(
    'https://domain.ltd/confirm_phone_change/1',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/confirm_phone_change/1'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->get(
    'https://domain.ltd/tags/delete/1',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/tags/delete/1'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
url = 'https://domain.ltd/tags/edit/1'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/storage-manager/upload',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/storage-manager/upload'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->get(
    'https://domain.ltd/storage-manager/browse',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/storage-manager/browse'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/complains/article/send',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/complains/article/send'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/complains/comment/send',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/complains/comment/send'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->get(
    'https://domain.ltd/moderation_answer/1/confirm',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/moderation_answer/1/confirm'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/user/permissions',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/user/permissions'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/tags/search',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/tags/search'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->get(
    'https://domain.ltd/api/search/city',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/search/city'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->get(
    'https://domain.ltd/api/search/country',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/search/country'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
url = 'https://domain.ltd/api/logout'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/reset-password',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/reset-password'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/forgot/send-code',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/forgot/send-code'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/forgot/change-password',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/forgot/change-password'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/forgot/check-code',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/forgot/check-code'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/forgot/check-login',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/forgot/check-login'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/register/check-login',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/register/check-login'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/register/check-email',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/register/check-email'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/register/check-phone',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/register/check-phone'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/register/send-code',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/register/send-code'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/api/register/check-code',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/api/register/check-code'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->get(
    'https://domain.ltd/settings/site',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/settings/site'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
...
$client = new \GuzzleHttp\Client();
$response = $client->post(
    'https://domain.ltd/settings/site/update',
    [
        'headers' => [
            'Content-Type' => 'application/form-data',
            'Accept' => 'application/form-data',
...
url = 'https://domain.ltd/settings/site/update'
headers = {
  'Content-Type': 'application/form-data',
  'Accept': 'application/form-data'
}
