...
return [
    ...
    */
    ...
    'domain_exists' => 'Такой домен не существует в системе. Добавьте домен.',
    'between' => [
    ...
    "recaptcha" => 'Поле :attribute некорректно.',
    ...
    'domain' => 'Неизвестный системе домен',
    'our_domain' => 'Ссылка не принадлежит сайту',
    'facebook' => 'Facebook URL не найден',
    'instaram' => 'Instagram URL не найден',
    'vk' => 'Vkontakte URL не найден',
    'ok' => 'Odnoklassniki URL не найден',
    'twitter' => 'Twitter URL не найден',
    /*
    |--------------------------------------------------------------------------
