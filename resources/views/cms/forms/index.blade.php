                                ...
                                <table class="table">
                                    ...
                                    @foreach ($field['fields'] as $item)
                                        <tr data-toggle="collapse">
                                            ...
                                            <td>
                                                {{\App\Models\Field::$fieldTypes[$item->field_type]['name']}}
                                            </td>
                                            <td>
                                                <a href="{{ route('forms.edit', ['form' => $item->id]) }}"
                                                   class="btn
                                                btn-default btn-sm"
                                                   onclick="window.location.href=$(this).attr('href');"><i
                                                            class="fas fa-pencil-alt"></i></a>
                                                <a href="{{ route('forms.destroy', ['form' => $item->id], false) }}"
