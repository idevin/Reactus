@set('fromUser', $activity->fromUser)
@set('user', $activity->user)

@if($activity->FromObject() && $activity->object())
    <div class="comment-item comment-top">
            ...
            <div class="comment-user">
                <div class="navbar-user navbar-user-white">
                    ...
                    <div class="navbar-user-info">
                        ...
                        <p class="navbar-user-role">Писатель {{$fromUser->rating}} lvl</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="comment-body">
            <div class="comment-body-activity">
                <p>
                    @if($fromUser->id != $user->id)
                        {{username($fromUser)}} ответил на комментарий:
                    @else
                        Вы ответили на свой комментарий:
                    @endif
                </p>
            ...
            <div class="comment-body-preview">
                {!! html_entity_decode($activity->object()->content) !!}
            </div>
        </div>
    </div>
@endif