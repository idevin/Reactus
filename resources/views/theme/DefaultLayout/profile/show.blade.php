                    ...
                    <div class="clearfix">
                        ...
                        @if(\Auth::user()->id == $user->id)
                            <div class="profile-section-action pull-right">
                                <a href="{{route_to_public_profile($user)}}/edit">Редактировать</a>
                            </div>
                        @endif
                        ...
                        @if($hidden == true)
                            <div style="align:center;">Тут ничего не найдено...</div>
                        @endif
                    </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            @if(!empty($fieldGroupsArray))
                                ...
                                <div class="row show-more-button">
                                    <br>
                                    <button type="button" class="btn btn-primary btn-lg btn-xlg btn-show-more">Показать больше</button>
                                </div>
                                <div class="row show-less-button">
                                    <br>
                                    <button type="button" class="btn btn-primary btn-lg btn-xlg btn-show-less">Закрыть</button>
                                </div>
                            @endif
                        </div>
                    </div>
